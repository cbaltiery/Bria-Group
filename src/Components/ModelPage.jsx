...
const ModelPage = (props) => {
   ...
   {/* Section #1 */}
    ...
    <div className='model-top-photo-haze'> */}
      {/* <div id="upper-top">
          <h1 className='card-title'>Explore the BRIA model</h1>
      </div> */}
      {/* <div class="row"> */}
        {/* <div class="col-sm-6" style={{"padding":"5em"}}>
          <div class="mid-model-card">
            <div class="card-body">
              <h5 class="card-title">FRAMEWORK</h5>
                <p class="card-text" style={{'color' : 'white'}}> 
                <ul className='card-list-text'>
                  <b>
                ...
                <ul className='card-list-text'><b>
                  <li>Accreditation</li>
                  <li>Governance</li>
                  <li>Funding</li></b>
                </ul>
                <h5 className='card-title'>OPERATING PRINCIPLES</h5>
                <ul className='card-list-text'>
                  <b>
        ...
        <div class="mid-model-card">
          <div class="card-body">
            <h5 class="card-title">SYSTEMS & PRINCIPLES AT WORK</h5>
            <p class="card-text"> 
              <ul className='card-list-text'>
                <b>
      ...
      {/* Section #2 */}
    <div className="bottom" style={{'backgroundColor' : 'lightgray'}}>
      <div id="upper-bottom">
        <h1 style={{'color' : 'white', 'fontSize' : '10em', 'textAlign': 'left'}}><b>bria framework</b></h1>
      </div>
      <div id="middle-top">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="model-card bottom-card">
          <div class="card-body">
      ...
      <div class="col-sm-6">
        <div class="model-card bottom-card">
          <div class="card-body">
            ...
            <p>Finally, BRIA supports the ongoing refinement of this operating model through a framework of rapid and creative prototyping, aggressive data capture and analysis, and a culture of supportive knowledge sharing. 
            </p>
      </div>
    </div>
  </div>
...
{/* Card - Bria Naturalists */}
  <div class="row">
  <div class="col-sm-6">
    <div class="model-card bottom-model-card">
      <div class="card-body">
        <h5 class="card-title bottom-title">BRIA Naturlaists</h5>
        <hr />
...
<h6>10-Yr Goal: <b>13,000 BRIA Naturalists</b> accredited</h6>
  ...
  <div class="col-sm-6 " >
    <div class="model-card bottom-model-card">
      <div class="card-body">
      <h5 class="card-title bottom-title" >BRIA Gardens</h5>
        <hr />
        <p class="card-text" style={{'color' : 'olive'}}> 
...
{/* Card Bria Roundtablesy */}
<div class="row" style={{'marginTop': '5em'}}>
  <div class="col-sm-6">
    <div class="model-card bottom-model-card">
      <div class="card-body">
        <h5 class="card-title bottom-title" >BRIA Rountables</h5>
        <hr />
        <p class="card-text" style={{'color' : 'olive'}}> 
  ...
  {/* Card Bria Institutes */}
  <div class="col-4" >
    <div class="model-card bottom-model-card">
      <div class="card-body">
      <h5 class="card-title bottom-title" >BRIA Institutes</h5>
        <hr />
        <p class="card-text" style={{'color' : 'olive'}}> 
      ...
      <div class="row">
        ...
        <div class="col-4">
          <div class="model-card bottom-model-card">
            ...
            <h6 style={{'color' : 'green', 'marginBottom' : '2em', 'marginRight' : '1em' , 'marginLeft' : '1em', 'marginTop' : '1em'}}>Learn more about our mission, vision and values.</h6>
          </div>
        </div>
...
<div className="bottom" style={{'backgroundColor' : 'burlywood'}}>
  <div class="row">
  <div class="col-sm-6">
    <div class="model-card footer-card">
      <div class="card-body">
        <p class="card-text"> 
