...
{/* throughout the page there is a box on the right side with hyperlinks */}
   ...
   <h2>Explore the BRIA model.</h2>
   {/* box on left in an ul */}
   <h5>FRAMEWORK</h5>
<ul>
    <li>BRIA Naturalists</li>
    <li>BRIA Gardens</li>
    <li>BRIA Roundtables</li>
    <li>BRIA Institutes</li>
</ul>
...
<ul>
    ...
    <li>Hyperlocal</li>
    <li>Systems Driven</li>
</ul>

<h5>SYSTEMS & PRINCIPLES AT WORK</h5>
<ul>
    ...
    <li>Funding Prototyping</li>
</ul>
{/* above is what i what i would consider part 1 */}


<h1>bria</h1>
<h4>The Botanical Research Institutes of America is an accrediting body and parent organization designed to foster the creation of botanical conservation programs across the United States.</h4>
...
<p>BRIA's chapter structure supports rapid rollout in new communities, ordering a replicable, streamlined operating model. </p>
...
<ul>
    ...
    <li>activity in conservation projects and research, and</li>
    <li>service to their community.</li>
</ul>
<h5>Ultimately, the equivalent of a master's degree in botany or ecology will be offered through BRIA Naturalist accreditation.</h5>
<h6>10-Yr Goal: 13,000 BRIA Naturalists accredited</h6>

<h4>BRIA Gardens</h4>
<h5>BRIA offers the first accreditation in the United States for non-professional botanical gardens.</h5>
...
<h6>10-Yr Goal: 10,000 BRIA Gardens accredited</h6>

<h4>BRIA Rountables</h4>
<h5>What if we told you you could turn your entire city into a botanical research garden? </h5>
...
<h6>10-Yr Goal: BRIA Roundtables established in 170 cities and towns</h6>
<h6>10-Yr Goal: $850M raised for plant conservation</h6>

<h4>BRIA Institutes</h4>
...
<ul>
    ...
    <li>Inclusion of the arts as an avenue for deep connection to the community.</li>
    <li>A culture of collaboration and a shared interest in the success of their sister Institutes nationwide.</li>
</ul>
    ...
    <h6>10-Yr Goal: 30 BRIA Institutes established</h6>
    <h6>10-Yr Goal: 650 scientists employed</h6>
    {/* The above is what i would consider part II */}
...
<ul>
    ...
    <li>build a fondation fo hard science skillsand competencies at the individual and group level; and</li>
    <li>create meaningful connections between scientists, property owners, philanthropists and volunteers.</li>
</ul>
<h4>Accreditation knits the BRIA framework together.</h4>
...
<ul>
    ...
    <li>a Garden must join a Rountable, engage an accredited Naturalist, or join a new research project;</li>
    <li>a Rountable will need member Gardens and member Naturalists that have reached higher levels of accreditation.</li>
</ul>
...
<ul>
    ...
    <li>transparent finances and resource managment,</li>
    <li>wealth building and investment managed by local stakeholder communities, and</li>
    <li>an open, well-documented history of the develpment of governence structures and policies.</li>
</ul>
...
<h4>At BRIA, we're creating a robust funding ecosystem.</h4>
...
<h4>Future-focused funding strategies.</h4>
...
{/* THE ABOVE IS WHAT I WOULD CONSIDER PART III */}

<h5>OPERATING PRINCIPLES</h5>
{/* this tag used to divide parts III and IV */}

<h4>Hyperlocal</h4>
<h6>Botany.Everywhere</h6>
<p>Backyards, campusesm hotel grounds, corporate parks... this is where the future of plant conservation lies.</p>
<p>What is hyperlocal conservation? Real science happening where you live and work. Real relationships between property owners, scientists and students. Donors large and small seeing their dollars at work in their own communities. Young aspiring scientists finding meaningful employment right in their own neighborhoods.</p>
<h4>Because when communities are steeped in science...we can change the world.</h4>

<h4>Value Centered</h4>
<p>As we operate to save the biosphere, we look to our values first.</p>
<h4>We are heart-centered. Radically creative. Inclusive & equitable. </h4>
{/* contains green font and a hyperlink to mission page */}
<h6>Learn more about our mission, vision and values.</h6>

<h4>Systems Driven</h4>
<p>Scaling at speed requires systems thinking.</p>
<p>Innovation that can be replicated. Automation that breaks down barriers to particpation. Data collection focused on outcomes--for the biosphere, and for the people who are saving it. We're developing a future-proof ecosystem where the work of conservation can thrive.</p>

{/* THE ABOVE IS PART IV */}

<h5>OPERATING PRINCIPLES</h5>
<h3>Streamlined & Automated</h3>
...
<ul>
    ...
    <li>Turnkey fundraising and donor management</li>
    <li>Streamlined governance powered by technology...including recorded meetings, pre-generated administrative documents, automated reporting, centralized records, and online signature capture</li>
    <li>Hassle-free bookkeeping that strategically manages risk using transparent, real-time exceptions auditing</li>
</ul>

<h5>OPERATING PRINCIPLES</h5>
<h3>Distributed & Inclusive</h3>
...
<ul>
    ...
    <li>Governance and investment decisions sourced by BRIA members nationwide using decentralized web3 technologies.</li>
    <li>National botanical research projects that can be joined -- and improved -- by any property owner or amateur naturalist.</li>
</ul>
...
<p>Aggressive data capture with real-time analysis to match is the fuel that will drive the success of BRIA's ever-evolving systems. Success in commnity building. Success in fundraising. Success in conservation research. It all depends on timely access to good data. What can good data offer?
    <ul>
        <li>Engagement insights that let you know if your local BRIA members are feeling plugged-in to your organization.</li>
        <li>A smart learning gateway that automatically offers a student that terms they are most likely to have forgotten since they lost logged into their Plant Physiology course. </li>
        <li>The particular fundraising postcard proven most likely to succeed in your community.</li>
    </ul>
</p>


<h5>OPERATING PRINCIPLES</h5>
<h3>Rapidly Evolving</h3>
